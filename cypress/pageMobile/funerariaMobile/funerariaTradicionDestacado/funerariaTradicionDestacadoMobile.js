...
class FunerariaTradicionDestacadoMobile {
    ...
    ingresoFunerariaTradicionDestacadoMobile(url){
        cy.viewport('iphone-xr')
        cy.visit(url.urlFunerariaTradicionDestacado)
        cy.clearCookies();   
...
const funerariaTradicionDestacadoMobile = new FunerariaTradicionDestacadoMobile ()
export default funerariaTradicionDestacadoMobile