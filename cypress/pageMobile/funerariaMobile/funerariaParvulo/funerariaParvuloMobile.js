...
class FunerariaParvuloMobile {
    //ingreso a la URL de Funeraria plan Parvulo Mobile
    ingresoFunerariaParvuloMobile(){
        cy.viewport('iphone-xr')
        cy.visit('https://preprod.parquedelrecuerdo.cl/productos-pdp/funeraria/plan-parvulo')
        cy.clearCookies();   
...
const funerariaParvuloMobile = new FunerariaParvuloMobile ()
export default funerariaParvuloMobile