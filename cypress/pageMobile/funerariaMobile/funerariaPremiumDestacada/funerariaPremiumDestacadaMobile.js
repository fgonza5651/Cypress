...
class FunerariaPremiumDestacadaMobile {
    //ingreso a la URL de Funeraria plan PremiumDestacada Mobile
    ingresoFunerariaPremiumDestacadaMobile(){
        cy.viewport('iphone-xr')
        cy.visit('https://preprod.parquedelrecuerdo.cl/productos-pdp/funeraria/funeraria-plan-homenaje-premium-destacado')
        cy.clearCookies();   
...
const funerariaPremiumDestacadaMobile = new FunerariaPremiumDestacadaMobile ()
export default funerariaPremiumDestacadaMobile