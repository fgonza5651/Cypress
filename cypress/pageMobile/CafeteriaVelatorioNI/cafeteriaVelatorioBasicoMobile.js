...
const popUpServicioVerDetalle = '#mat-tab-content-2-0 > .mat-tab-body-content'
const btnVerDetalleCafeteriaEstandar = ':nth-child(2) > .valor-ss-aa > .btn-ver-detalle-mobile'
...
class cafeteriaVelatorioBasicoMobile {
    ...
    verDetalleEstandar(){
        cy.wait(2000)
        cy.get(btnVerDetalleCafeteriaEstandar,{timeout:100000}).scrollIntoView().should('be.visible').click()
    }
    verDetallePremium (){
        cy.wait(2000)
        cy.get(btnVerDetalleCafeteriaPremium,{timeout:100000}).scrollIntoView().should('be.visible').click()
    }
...
const CafeteriaVelatorioBasicoMobile = new cafeteriaVelatorioBasicoMobile()
export default CafeteriaVelatorioBasicoMobile