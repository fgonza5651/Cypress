...
//botones de funeraria Solitaria
const btnFunerariaTradicionSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-active > div > div.cont-img-producto'
const btnFunerariaTradicionDestacadaSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-next > div > div.cont-img-producto'
const btnFunerariaSustentableSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-active > div > div.cont-img-producto'
const btnFunerariaPremiumSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-next > div > div.cont-img-producto'
const btnFunerariaPremiumDestacadaSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-next > div > div.cont-img-producto'
//botones de Descanso de cenizas
const btnDescansoParedSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-active > div > div.cont-img-producto'
const btnDescansoFloresPremiumSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-next > div > div.cont-img-producto'
const btnDescansoFloresSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-active > div > div.cont-img-producto'
const btnDescansoMemorialSola = '#cont-swipper-otras-opciones > swiper > div > div.swiper-slide.ng-star-inserted.swiper-slide-next > div > div.cont-img-producto'
...
const btnFunerariaTradicion = '#cont-swipper-otras-opciones > swiper > div > div:nth-child(1) > div > div.cont-img-producto'
const btnFunerariaTradicionDestacada = '#cont-swipper-otras-opciones > swiper > div > div:nth-child(2) > div > div.cont-img-producto'
const btnFunerariaSustentable = '#cont-swipper-otras-opciones > swiper > div > div:nth-child(3) > div > div.cont-img-producto'
const btnFunerariaPremium = '#cont-swipper-otras-opciones > swiper > div > div:nth-child(4) > div > div.cont-img-producto'
const btnFunerariaPremiumDestacada = '#cont-swipper-otras-opciones > swiper > div > div:nth-child(5) > div > div.cont-img-producto'
...
class CremacionFullNIMobile {
    ...
    ingresoCremacionFullNIMobile(url){
    ...
    agregarFunerariaTradicionSola(){
        cy.get(btnDetalleFuneraria,{timeout:100000}).should('be.visible').click()
        cy.get(btnFunerariaTradicionSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioFuneraria')
        })
    ...
    agregarFunerariaTradicionDestacadoSola(){
        cy.get(btnDetalleFuneraria,{timeout:100000}).should('be.visible').click()
        cy.get(btnFunerariaTradicionDestacadaSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioFuneraria')
        })
    ...
    agregarFunerariaSustentableSola(){
        cy.get(btnDetalleFuneraria,{timeout:100000}).should('be.visible').click()
        cy.get(btnFunerariaSustentableSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioFuneraria')
        })
    ...
    agregarFunerariaPremiumSola(){
        cy.get(btnDetalleFuneraria,{timeout:100000}).should('be.visible').click()
        cy.get(btnFunerariaPremiumSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioFuneraria')
        })
    ...
    agregarFunerariaPremiumDestacadoSola(){
        cy.get(btnDetalleFuneraria,{timeout:100000}).should('be.visible').click()
        cy.get(btnFunerariaPremiumDestacadaSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioFuneraria')
        })
    ...
    agregarDescansoParedSola(){
        cy.get(btnDetalleDescanso,{timeout:100000}).should('be.visible').click()
        cy.get(btnDescansoParedSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioDescanso')
        })
    ...
    agregarDescansoFloresPremiumSola(){
        cy.get(btnDetalleDescanso,{timeout:100000}).should('be.visible').click()
        cy.get(btnDescansoFloresPremiumSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioDescanso')
        })
    ...
    agregarDescansoFloresSola(){
        cy.get(btnDetalleDescanso,{timeout:100000}).should('be.visible').click()
        cy.get(btnDescansoFloresSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioDescanso')
        })
    ...
    agregarDescansoMemoriarSola(){
        cy.get(btnDetalleDescanso,{timeout:100000}).should('be.visible').click()
        cy.get(btnDescansoMemorialSola,{timeout:100000}).click()
        cy.get(precioAgregado,{timeout:100000}).invoke('text').then((text) => {
            cy.log(text);
            cy.wrap(text).as('precioDescanso')
        })
