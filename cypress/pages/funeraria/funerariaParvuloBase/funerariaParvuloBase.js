...
class FunerariaParvuloBase {
    //ingreso a la URL de funeraria plan ParvuloBase
    ingresarFunerariaParvuloBase(){
        cy.visit('https://preprod.parquedelrecuerdo.cl/productos-pdp/funeraria/funeraria-plan-parvulo-base')
        cy.clearCookies();   
...
const funerariaParvuloBase = new FunerariaParvuloBase()
export default funerariaParvuloBase