...
class funnelFunerariaNI {

    //ingresa al flujo funnel cremacion NI
    
    inicioFlujoFunerariaNI(url){

        cy.visit(url.urlFlujoFunerarioNI)
        cy.wait(2000)
        cy.clearCookies();   
...
const FunnelFunerariaNI = new funnelFunerariaNI()
export default FunnelFunerariaNI;