...
const btnContinuarSinEstosServicios = '//*[@id="mat-tab-content-0-1"]/div/div[2]/div[1]/button'
...
class funnelFunerariaNIF {

    //ingresa al flujo funnel cremacion NI
    
    inicioFlujoCremacion(){

        cy.visit('https://ic.parquedelrecuerdo.cl/funnel/inicio-flujo?producto=funeraria-nif')
        cy.wait(2000)
        cy.clearCookies();   
    ...
    seleccionPlanBasico(){
      ...
      verMasPlanBasico(){
        ...
        cy.wait(2000)
        cy.get(precioPlanBasico,{timeout:50000})
        .invoke('text') //obtengo el texto del elemento
        .then((precio) => {
        ...
        cy.get(btnVerMasPlanBasico, {timeout: 5000}).should('be.visible').click()
    ...
    seleccionNecesitoCremacion(){
        cy.wait(3000)
        cy.get(btnNecesitoCremacion,{timeout: 100000}).should('be.visible').click()
        cy.wait(3000)    
    }
    seleccionNecesitoSepultura(){
        cy.wait(3000)
        cy.get(btnNecesitoSepultura,{timeout: 100000}).should('be.visible').click()
        cy.wait(3000)    
    }
    ...
    verMasCermmoniaDeDespedidaIncluida(){
        cy.get(btnVerMasCeremoniaDespedidaIncluida,{timeout: 5000}).should('be.visible').click()
        cy.wait(3000)
        cy.get(sidenavServicio,{timeout:100000}).should('be.visible')
        cy.wait(3000)
    }
    ...
    verMasCeremoniaDespeidaEspecial(){
      ...
      cy.get(btnVerMasCeremoniaDespedidaEspecial, { timeout: 50000 }).should('be.visible').click();
      cy.wait(2000)
    ...
    verMasCeremoniaDespedidaConCoro(){
        ...
        cy.get(btnVerMasCeremoniaDespedidaConCoro, { timeout: 50000 }).should('be.visible').click();
        cy.wait(2000)
    ...
    verMasCeremoniaDespedidaEspecialConCoro(){
        ...
        cy.get(btnVerMasCeremoniaDespedidaEspecialConCoro, { timeout: 50000 }).should('be.visible').click();
        cy.wait(2000)
        cy.get(precioServicioSidenav,{timeout:100000}) // Captura el precio del carrito o el lugar donde lo comparas
        .invoke('text')
        .then((precio) => {
    ...
    verMasAnaforaCofreFull(){
        ...
        cy.get(btnVerMasAnaforaCofresFull, { timeout: 5000 }).should('be.visible').click();
        cy.wait(2000)
        cy.get(precioServicioSidenav,{timeout:100000}) // Captura el precio del carrito o el lugar donde lo comparas
        .invoke('text')
        .then((precio) => {
    ...
    verMasAnaforaCofrePremium(){
        ...
        cy.get(btnVerMasAnaforaCofrePremium, { timeout: 5000 }).should('be.visible').click();
        cy.wait(2000)
        cy.get(precioServicioSidenav,{timeout:100000}) // Captura el precio del carrito o el lugar donde lo comparas
        .invoke('text')
        .then((precio) => {
    ...
    verMasEntregaCenizasEspecial(){
        ...
        cy.get(btnVerMasEntregaCenizasEspecial, { timeout: 5000 }).should('be.visible').click();
        cy.wait(2000)
        cy.get(precioServicioSidenav,{timeout:100000}) // Captura el precio del carrito o el lugar donde lo comparas
        .invoke('text')
        .then((precio) => {
...
const FunnelFunerariaNIF = new funnelFunerariaNIF()
export default FunnelFunerariaNIF;